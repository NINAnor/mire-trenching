...
Alternatively, we can use things like AR5, or a combination of the two.

Secondly, by excluding everything that is no (open) mire,
...
reflection the land use change and the associated loss of the areas in worst condition. 
...
The first option is the one that best fit the accounting standards.
The suggested way to overcome the _false message_ that wetlands may develop better
